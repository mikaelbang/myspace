...
class Wallcontroller{
    ...
    public function showAction(){
        ...
        $postStm = $db->prepare('SELECT * FROM posts AS P JOIN users AS U ON (P.user_id = U.user_id) JOIN followers AS F ON (F.followee = U.user_id) LEFT JOIN comments AS C ON (C.post_id = P.post_id) WHERE F.follower = :currentUser');
